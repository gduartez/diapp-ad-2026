window.RevealQuiz = function () {
  ...
  function updateScore(deck, scoreElement, correctCount, totalCount) {
    ...
    scoreElement.textContent = `${percentage}% Correctas (${correctCount}/${totalCount})`;
  }
  ...
  return {
    ...
    init: function (deck) {
      ...
      checkButton.innerHTML = "Revisar";
      resetButton.innerHTML = "Reiniciar";
      prevButton.innerHTML = "Previo";
      ...
      settings.defaultCorrect = options.defaultCorrect || "Correcto!";
      settings.defaultIncorrect = options.defaultIncorrect || "Incorrecto!";
