...
# Tema informa de víctimas de homicidio consumado (opcional)
theme_g1 <-   theme(
...
## Ejercicio aplicado 1: Histograma --------------------------------------
library(gapminder)
library(ggplot2)
library(dplyr)
...
ggplot(homicidios_rm_sf |> 
  ...
  geom_sf(aes(fill = tasa_hom_2024), color = 'grey100', linewidth = .2) +
