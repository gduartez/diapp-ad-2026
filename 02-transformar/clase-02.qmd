...
- `filter()` conserva las filas que **cumplen todas** las condiciones
  indicadas. Las condiciones se separan por coma (equivale a utilizar `&` entre ellas).
...
- Con el argumento `wt` podemos **sumar** una variable en vez de contar
  filas, mientras que con el argumento `name` se puede cambiar el nombre de la variable de recuento (o suma):
